...
const SectionList = () => {
    ...
    const getProgram = async () => {
        const data = await api.fetchSection();
        const model = parentExtractor(data.data[0]?.parent_type)
        setProgram(data.data?.section)
            ...
            <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-blue-500">
                    <tr>
                        ...
                        <th className="px-4 py-2 text-left text-sm font-medium text-white">Section</th>
                        <th className="px-4 py-2 text-left text-sm font-medium text-white">Seat</th>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                    {program?.map((data, index ) => (
                        <tr key={data.id}>
                            ...
                            <td className="px-4 py-2 text-sm text-gray-700">{data?.seat}</td>
