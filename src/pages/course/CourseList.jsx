            ...
            <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-blue-500">
                    <tr>
                        ...
                        <th className="px-4 py-2 text-left text-sm font-medium text-white">Course</th>
                        <th className="px-4 py-2 text-left text-sm font-medium text-white">Course Code</th>
                        <th className="px-4 py-2 text-left text-sm font-medium text-white">Catagory</th>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                    {program?.map((data, index ) => (
                        <tr key={data.id}>
                            ...
                            <td className="px-4 py-2 text-sm text-gray-700">{data?.code}</td>
                            <td className="px-4 py-2 text-sm text-gray-700">{data?.category?.name}</td>
