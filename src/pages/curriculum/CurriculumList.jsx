...
const CurriculumList = () => {
    ...
    const getClassRoom = async () => {
        ...
        setProgram(data.data?.curriculum)
            ...
            <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-blue-500">
                    <tr>
                        ...
                        <th className="px-4 py-2 text-left text-sm font-medium text-white">Curriculum</th>
                        <th className="px-4 py-2 text-left text-sm font-medium text-white">Courses</th>
                        <th className="px-4 py-2 text-left text-sm font-medium text-white">Version</th>
                        <th className="px-4 py-2 text-left text-sm font-medium text-white">Approval Date</th>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                    {program?.map((data, index ) => (
                        <tr key={data.id}>
                            ...
                            <td className="px-4 py-2 text-sm text-gray-700">{data?.courses}</td>
                            <td className="px-4 py-2 text-sm text-gray-700">{data?.version}</td>
                            <td className="px-4 py-2 text-sm text-gray-700">{data?.approval_date}</td>
