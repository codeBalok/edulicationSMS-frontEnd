...
const ClassYearList = () => {
    ...
    const getClassRoom = async () => {
        const data = await api.fetchClassYear();
        const model = parentExtractor(data.data[0]?.parent_type)
        setProgram(data.data?.class_year)
            ...
            <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-blue-500">
                    <tr>
                        ...
                        <th className="px-4 py-2 text-left text-sm font-medium text-white">Class/Year</th>
                        ...
                        <th className="px-4 py-2 text-left text-sm font-medium text-white">Intake</th>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                    {program?.map((data, index ) => (
                        <tr key={data.id}>
                            ...
                            <td className="px-4 py-2 text-sm text-gray-700">{data?.year_number}</td>
                            ...
                            <td className="px-4 py-2 text-sm text-gray-700">{data?.intake}</td>
