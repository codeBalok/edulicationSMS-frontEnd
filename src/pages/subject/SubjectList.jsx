...
const SubjectList = () => {
    ...
    const getClassRoom = async () => {
        const data = await api.fetchSubject();
        const model = parentExtractor(data.data[0]?.parent_type)
        setProgram(data.data?.subject)
            ...
            <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-blue-500">
                    <tr>
                        ...
                        <th className="px-4 py-2 text-left text-sm font-medium text-white">Subject</th>
                        <th className="px-4 py-2 text-left text-sm font-medium text-white">Code</th>
